/*
  ...
  - You are about to drop the `crm_hospital` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropTable
DROP TABLE `crm_hospital`;
...
CREATE TABLE `mbcrm_hospital` (
    ...
    INDEX `mbcrm_hospital_hospital_id_user_id_hospital_name_idx`(`hospital_id`, `user_id`, `hospital_name`),
